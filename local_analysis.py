...
# python local_analysis.py -gpuid '0,1' -modeldir './saved_models/resnet50/datasets/CUB_200_2011/train/001' -model '30push0.8265.pth' -imgdir 'datasets/CUB_200_2011/test/001.Black_footed_Albatross' -img 'Black_Footed_Albatross_0002_55.jpg' -imgclass 1
...
save_analysis_path = os.path.join('./saved_visualizations', load_model_dir.split('/')[1],
                                  test_image_name[:-4])
...
if check_test_accu:
    # import wandb
    # wandb.init(project='CV Project', config={"test": "test"})
    test_batch_size = 100
